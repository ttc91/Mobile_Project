...
@androidx.room.Database(entities = {UserEntity.class, HabitEntity.class, DayOfWeekEntity.class, DayOfTimeEntity.class, HabitInWeekEntity.class, HistoryEntity.class}, version = 1)
